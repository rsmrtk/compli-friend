...
▫️ <code>/start</code> — Початок мандрівки
▫️ <code>/get</code> — Миттєвий прогноз
▫️ <code>/info</code> — Принципи роботи
▫️ <code>/about</code> — Про філософію бота

🔍 <b>Поширені проблеми:</b>
→ Передбачення загадкові? Це частина магії!
→ Бажаєш змінити час сповіщень? Пиши "налаштування"

📩 <i>Звʼязок з творцями:</i> @ваш_юзернейм""",
        parse_mode='HTML',
        reply_markup=main_keyboard()
    )
